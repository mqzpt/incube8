...
const PitchDetails = () => {
  ...
  const { donate, getinvestments, contract, address } = useStateContext();
    ...
    <div>
      ...
      <div className="w-full flex md:flex-row flex-col mt-10 gap-[30px]">
        <div className="flex-1 flex-col">
          <img src={state.image} alt="pitch" className="w-full h-[410px] object-cover rounded-xl"/>
          ...
          <div>
            ...
            <div className="mt-[20px] flex flex-row items-center flex-wrap gap-[14px]">
              ...
              <div>
                ...
                <p className="mt-[4px] font-epilogue font-normal text-[12px] text-[#808191]">10 Pitches</p>
              </div>
            </div>
          </div>
          ...
          <div>
            <h4 className="font-epilogue font-semibold text-[18px] text-white uppercase">investors</h4>
              ...
              <div className="mt-[20px] flex flex-col gap-4">
                {investors.length > 0 ? investors.map((item, index) => (
